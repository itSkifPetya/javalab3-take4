...
public class HumanBeing implements Comparable<HumanBeing> {
    ...
    private final static HumanBeing example = new HumanBeing("Alex",new Coordinates(1, 1.0),true,true,100.0,"Everybody loves me",100,WeaponType.SHOTGUN,new Car(true));


    public static HumanBeing getExample() {
        return example;
    }
